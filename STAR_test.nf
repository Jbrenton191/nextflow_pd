...
STAR --runThreadN 35 --runMode genomeGenerate --genomeDir ${gdir_val} --genomeFastaFiles /home/jbrenton/nextflow_test/output/STAR/genome_dir/Homo_sapiens.GRCh38.97.dna.primary_assembly.fa --sjdbGTFfile /home/jbrenton/nextflow_test/output/STAR/genome_dir/Homo_sapiens.GRCh38.97.gtf --sjdbOverhang 99
  """
}
...
//	STAR_pass1_post_genome_gen(data, STAR_genome_gen.out.some_path.collect(), STAR_genome_gen.out.gdir_val)
	STAR_pass1_post_genome_gen(data, STAR_genome_gen.out.gdir_val)
//   gdir_val='/home/jbrenton/nextflow_test/output/STAR/genome_dir' 
